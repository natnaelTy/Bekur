...
export default function DashboardPage() {
  ...
  return (
    <div className="w-full py-24 px-3 md:px-10">
      <div className="space-y-2 mb-6">
      <h1 className="text-3xl md:text-4xl font-bold">Selam, {user?.name} 👋🏽</h1>
      <p className="text-sm md:text-base max-w-xl">Welcome to your dashboard. Here you can find all the information related to your application.</p>
      </div>
